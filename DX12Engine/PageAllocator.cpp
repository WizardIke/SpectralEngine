...
void PageAllocator::addPackedPages(const VirtualTextureInfo& textureInfo, std::size_t numPages, ID3D12CommandQueue* commandQueue, ID3D12Device* graphicsDevice)
{
