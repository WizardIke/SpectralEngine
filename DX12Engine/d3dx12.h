...
//------------------------------------------------------------------------------------------------
template <typename value_type, typename U, typename V>
inline void D3D12DecomposeSubresource(UINT Subresource, UINT MipLevels, UINT ArraySize, _Out_ value_type& MipSlice, _Out_ U& ArraySlice, _Out_ V& PlaneSlice)
{
	MipSlice = static_cast<value_type>(Subresource % MipLevels);
