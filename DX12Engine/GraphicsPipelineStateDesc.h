...
{
public:
	ResourceLocation vertexShaderResource;
	ResourceLocation pixelShaderResource;

	constexpr GraphicsPipelineStateDesc(ResourceLocation vertexShaderFileName1, ResourceLocation pixelShaderFileName1,
	...
	DSVFormat, SampleDesc, 0u, {nullptr, 0u}, D3D12_PIPELINE_STATE_FLAG_NONE },
		vertexShaderResource(vertexShaderFileName1),
		pixelShaderResource(pixelShaderFileName1)
	{}
};