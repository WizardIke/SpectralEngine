...
RootSignatures::RootSignatures(ID3D12Device* const device)
{
	...
	rootParameters[0].ParameterType = D3D12_ROOT_PARAMETER_TYPE_CBV; //cameras
	...
	rootParameters[2].ParameterType = D3D12_ROOT_PARAMETER_TYPE_CBV; //vertex material
	rootParameters[2].Descriptor.ShaderRegister = 1u;
	rootParameters[2].Descriptor.RegisterSpace = 0u;
	rootParameters[2].ShaderVisibility = D3D12_SHADER_VISIBILITY_VERTEX;

	rootParameters[3].ParameterType = D3D12_ROOT_PARAMETER_TYPE_CBV; //pixel material
	...
	rootParameters[4].DescriptorTable.NumDescriptorRanges = sizeof(textureDescriptorTableRanges) / sizeof(textureDescriptorTableRanges[0]);
	rootParameters[4].DescriptorTable.pDescriptorRanges = textureDescriptorTableRanges;
