...
{
	class DirectionalLightVtTwoSided
	{
	...
	public:
		static inline GraphicsPipelineStateDesc desc =
		{
			...
			UINT{0xffffffff},
			D3D12_RASTERIZER_DESC{D3D12_FILL_MODE_SOLID, D3D12_CULL_MODE_NONE, FALSE, 0, 0, 0, TRUE, FALSE, FALSE, UINT{0ul}, D3D12_CONSERVATIVE_RASTERIZATION_MODE_OFF},
