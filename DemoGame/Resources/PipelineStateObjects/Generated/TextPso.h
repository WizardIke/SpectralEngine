...
namespace PipelineStateObjectDescs
{
	class Text
	{
		...
		{
			D3D12_INPUT_ELEMENT_DESC{"POSITION", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, UINT{0ul}, UINT{0ul}, D3D12_INPUT_CLASSIFICATION_PER_INSTANCE_DATA, UINT{1ul}},
			D3D12_INPUT_ELEMENT_DESC{"TEXCOORD", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, UINT{0ul}, D3D12_APPEND_ALIGNED_ELEMENT, D3D12_INPUT_CLASSIFICATION_PER_INSTANCE_DATA, UINT{1ul}},
			D3D12_INPUT_ELEMENT_DESC{"COLOR", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, UINT{0ul}, D3D12_APPEND_ALIGNED_ELEMENT, D3D12_INPUT_CLASSIFICATION_PER_INSTANCE_DATA, UINT{1ul}},
		};
