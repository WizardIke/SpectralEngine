...
{
	class VtFeedbackWithNormalsTwoSided
	{
	...
	public:
		static inline GraphicsPipelineStateDesc desc =
		{
			...
			UINT{1ul},
			{DXGI_FORMAT_R16G16B16A16_UINT, DXGI_FORMAT_UNKNOWN, DXGI_FORMAT_UNKNOWN, DXGI_FORMAT_UNKNOWN, DXGI_FORMAT_UNKNOWN, DXGI_FORMAT_UNKNOWN, DXGI_FORMAT_UNKNOWN, DXGI_FORMAT_UNKNOWN},
